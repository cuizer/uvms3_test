...
static const _HalWingservoMsg_type_support_symbol_names_t _HalWingservoMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hal, msg, HalWingservoMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hal, msg, HalWingservoMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hal, msg, HalWingservoMsg)() {
  return &::hal::msg::rosidl_typesupport_c::HalWingservoMsg_message_type_support_handle;
}
