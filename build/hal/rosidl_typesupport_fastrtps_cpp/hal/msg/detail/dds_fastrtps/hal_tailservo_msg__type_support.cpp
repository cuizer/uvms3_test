...
#include "hal/msg/detail/hal_tailservo_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hal::msg::HalTailservoMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hal::msg::HalTailservoMsg & ros_message)
{
  // Member: voltage
  {
    cdr >> ros_message.voltage;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hal
max_serialized_size_HalTailservoMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hal::msg::HalTailservoMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hal::msg::HalTailservoMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hal::msg::HalTailservoMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HalTailservoMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hal::msg::HalTailservoMsg *>(
...
static size_t _HalTailservoMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HalTailservoMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HalTailservoMsg__callbacks = {
  "hal::msg",
  "HalTailservoMsg",
...
static rosidl_message_type_support_t _HalTailservoMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HalTailservoMsg__callbacks,
...
{
  return &hal::msg::typesupport_fastrtps_cpp::_HalTailservoMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hal, msg, HalTailservoMsg)() {
  return &hal::msg::typesupport_fastrtps_cpp::_HalTailservoMsg__handle;
}
