...
#include "hal/msg/detail/hal_battery_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hal::msg::HalBatteryMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hal::msg::HalBatteryMsg & ros_message)
{
  // Member: battery_status
  cdr >> ros_message.battery_status;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hal
max_serialized_size_HalBatteryMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hal::msg::HalBatteryMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hal::msg::HalBatteryMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hal::msg::HalBatteryMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HalBatteryMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hal::msg::HalBatteryMsg *>(
...
static size_t _HalBatteryMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HalBatteryMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HalBatteryMsg__callbacks = {
  "hal::msg",
  "HalBatteryMsg",
...
static rosidl_message_type_support_t _HalBatteryMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HalBatteryMsg__callbacks,
...
{
  return &hal::msg::typesupport_fastrtps_cpp::_HalBatteryMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hal, msg, HalBatteryMsg)() {
  return &hal::msg::typesupport_fastrtps_cpp::_HalBatteryMsg__handle;
}
