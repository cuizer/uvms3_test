...
bool hal__msg__hal_wingservo_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hal.msg._hal_wingservo_msg.HalWingservoMsg", full_classname_dest, 42) == 0);
  }
  hal__msg__HalWingservoMsg * ros_message = _ros_message;
  {  // voltage
...
{
  /* NOTE(esteve): Call constructor of HalWingservoMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hal.msg._hal_wingservo_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HalWingservoMsg");
