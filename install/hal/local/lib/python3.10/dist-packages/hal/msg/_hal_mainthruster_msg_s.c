...
bool hal__msg__hal_mainthruster_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hal.msg._hal_mainthruster_msg.HalMainthrusterMsg", full_classname_dest, 48) == 0);
  }
  hal__msg__HalMainthrusterMsg * ros_message = _ros_message;
  {  // rpm
  ...
  {  // voltage
    ...
    assert(PyLong_Check(field));
    ros_message->voltage = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // fault_status
...
{
  /* NOTE(esteve): Call constructor of HalMainthrusterMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hal.msg._hal_mainthruster_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HalMainthrusterMsg");
  ...
  {  // voltage
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->voltage);
    {
