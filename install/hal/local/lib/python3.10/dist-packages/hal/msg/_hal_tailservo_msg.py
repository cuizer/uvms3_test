...
class Metaclass_HalTailservoMsg(type):
    """Metaclass of message 'HalTailservoMsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hal.msg.HalTailservoMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hal_tailservo_msg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hal_tailservo_msg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hal_tailservo_msg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hal_tailservo_msg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hal_tailservo_msg
...
class HalTailservoMsg(metaclass=Metaclass_HalTailservoMsg):
    """Message class 'HalTailservoMsg'."""
    ...
    def __init__(self, **kwargs):
        ...
        if 'voltage' not in kwargs:
            self.voltage = numpy.zeros(4, dtype=numpy.int16)
        else:
            self.voltage = kwargs.get('voltage')
        if 'current' not in kwargs:
            self.current = numpy.zeros(4, dtype=numpy.int16)
        else:
            self.current = kwargs.get('current')
        if 'power' not in kwargs:
            self.power = numpy.zeros(4, dtype=numpy.uint16)
        else:
            self.power = kwargs.get('power')
        if 'temperature' not in kwargs:
            self.temperature = numpy.zeros(4, dtype=numpy.uint16)
        else:
    ...
    def voltage(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 4, \
                "The 'voltage' numpy.ndarray() must have a size of 4"
            self._voltage = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'voltage' field must be a set or sequence with length 4 and each value of type 'int' and each integer in [-32768, 32767]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -32768 and val < 32768 for val in value)), \
                "The 'current' field must be a set or sequence with length 4 and each value of type 'int' and each integer in [-32768, 32767]"
    ...
    def power(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 4, \
                "The 'power' numpy.ndarray() must have a size of 4"
            self._power = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ...
                "The 'power' field must be a set or sequence with length 4 and each value of type 'int' and each unsigned integer in [0, 65535]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= 0 and val < 65536 for val in value)), \
                "The 'temperature' field must be a set or sequence with length 4 and each value of type 'int' and each unsigned integer in [0, 65535]"
