...
#ifndef HAL__MSG__DETAIL__HAL_WINGSERVO_MSG__TRAITS_HPP_
#define HAL__MSG__DETAIL__HAL_WINGSERVO_MSG__TRAITS_HPP_
...
inline std::string to_yaml(const HalWingservoMsg & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const hal::msg::HalWingservoMsg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hal::msg::HalWingservoMsg & msg)
{
  return hal::msg::to_yaml(msg);
}

template<>
inline const char * data_type<hal::msg::HalWingservoMsg>()
{
  return "hal::msg::HalWingservoMsg";
}

template<>
inline const char * name<hal::msg::HalWingservoMsg>()
{
  return "hal/msg/HalWingservoMsg";
}

template<>
struct has_fixed_size<hal::msg::HalWingservoMsg>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<hal::msg::HalWingservoMsg>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<hal::msg::HalWingservoMsg>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // HAL__MSG__DETAIL__HAL_WINGSERVO_MSG__TRAITS_HPP_
